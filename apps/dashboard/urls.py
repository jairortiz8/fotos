...
urlpatterns = [
    ...
    path("fotos/<int:pk>/dorsal/redetectar/", views.RerunOcrView.as_view(), name="rerun_ocr"),
    path("fotos/<int:pk>/dorsales/", views.BibsSectionView.as_view(), name="bibs_section"),
